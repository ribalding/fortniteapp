...
public class Weapons {
    ...
    private static final List<Weapon> ALL_WEAPONS = Arrays.asList(
            ...
            new Weapon("Bolt Action Sniper Rifle (Purple)",36.3,110,.33,1,2.8,"Epic", "Heavy","assault_rifle_green_image"),
            new Weapon("Bolt Action Sniper Rifle (Gold)",38.28,116,.33,1,2.7,"Legendary", "Heavy","assault_rifle_green_image"),
            new Weapon("Crossbow (Blue)",30,50,.6,5,2.2,"Rare", "Arrows","assault_rifle_green_image"),
            new Weapon("Crossbow (Purple)",45,75,.6,5,2.2,"Epic", "Arrows","assault_rifle_green_image"),
            new Weapon("Grenade Launcher (Purple)",105,105,1.0,6,2.8,"Epic", "Rockets","assault_rifle_green_image"),
            new Weapon("Grenade Launcher (Gold)",110,110,1.0,6,2.7,"Legendary", "Rockets","assault_rifle_green_image"),
            new Weapon("Handcannon (Purple)",60,75,.8,7,2.1,"Epic", "Heavy","assault_rifle_green_image"),
            new Weapon("Handcannon (Gold)",62.4,78,.8,7,2.0,"Legendary", "Heavy","assault_rifle_green_image"),
            new Weapon("Hunting Rifle (Green)",68.8,86,.8,1,1.9,"Uncommon", "Heavy","assault_rifle_green_image"),
            new Weapon("Hunting Rifle (Blue)",72,90,.8,1,1.8,"Rare", "Heavy","assault_rifle_green_image"),
            new Weapon("Minigun (Purple)",204,17,12.0,0,4.7,"Epic", "Light","assault_rifle_green_image"),
            new Weapon("Minigun (Gold)",204,17,12.0,0,4.7,"Legendary", "Light","assault_rifle_green_image"),
            new Weapon("Semi-Auto Sniper Rifle (Purple)",75.6,63,1.2,10,2.5,"Epic", "Heavy","assault_rifle_green_image"),
            new Weapon("Semi-Auto Sniper Rifle (Gold)",79.2,66,1.2,10,2.3,"Legendary", "Heavy","assault_rifle_green_image"),
            new Weapon("Pistol (Grey)",155.25,23,6.75,16,1.5, "Common", "Light","assault_rifle_green_image"),
            new Weapon("Pistol (Green)",162,24,6.75,16,1.5, "Uncommon", "Light","assault_rifle_green_image"),
            new Weapon("Pistol (Blue)",168.75,25,6.75,16,1.4, "Rare", "Light","assault_rifle_green_image"),
            new Weapon("Suppressed Pistol (Purple)",175.5,26,6.75,16,1.3, "Epic", "Light","assault_rifle_green_image"),
            new Weapon("Suppressed Pistol (Gold)",189,28,6.75,16,1.3, "Legendary", "Light","assault_rifle_green_image"),
            new Weapon("Revolver (Grey)",48.6,54,.9,6,2.4, "Common", "Medium","assault_rifle_green_image"),
            new Weapon("Revolver (Green)",51.3,57,.9,6,2.3, "Uncommon", "Medium","assault_rifle_green_image"),
            new Weapon("Revolver (Blue)",54,60,.9,6,2.2, "Rare", "Medium","assault_rifle_green_image"),
            new Weapon("Rocket Launcher (Blue)",82.5,110,.75,1,2.3, "Rare", "Rockets","assault_rifle_green_image"),
            new Weapon("Rocket Launcher (Purple)",87,116,.75,1,2.2, "Epic", "Rockets","assault_rifle_green_image"),
            new Weapon("Rocket Launcher (Gold)",90.75,121,.75,1,1.9, "Legendary", "Rockets","assault_rifle_green_image"),
            new Weapon("Tactical Shotgun (Grey)",100.5,67,1.5,8,6.3,"Common","Shells n Slugs","assault_rifle_green_image"),
            new Weapon("Tactical Shotgun (Green)",105,70,1.5,8,6.0,"Uncommon","Shells n Slugs","assault_rifle_green_image"),
            new Weapon("Tactical Shotgun (Blue)",111,74,1.5,8,5.7,"Rare","Shells n Slugs","assault_rifle_green_image"),
            new Weapon("Suppressed Submachine Gun (Grey)",153,17,9.0,30,2.2,"Common","Light","assault_rifle_green_image"),
            new Weapon("Suppressed Submachine Gun (Green)",162,18,9.0,30,2.1,"Uncommon","Light","assault_rifle_green_image"),
            new Weapon("Suppressed Submachine Gun (Blue)",171,19,9.0,30,2.0,"Rare","Light","assault_rifle_green_image"),
            new Weapon("Tactical Submachine Gun (Green)",208,16,13.0,35,2.4,"Uncommon","Light","assault_rifle_green_image"),
            new Weapon("Tactical Submachine Gun (Blue)",221,17,13.0,35,2.4,"Rare","Light","assault_rifle_green_image"),
            new Weapon("Tactical Submachine Gun (Purple)",234,18,13.0,35,2.4,"Epic","Light","assault_rifle_green_image")
    );
    ...
    public static int compareWeaponStats (Double currentWeaponStat, Double potentialWeaponStat) {
        ...
        //if roundedDifferenceBetweenStats is positive then display green up arrow, if negative then display red arrow
    }
